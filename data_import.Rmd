...
Import smut ball incidence data used to calculate severely damaged pods (SDP).
...
Add smut density to the data object for model fitting.

```{r add-sdp}
mod_dat <- left_join(mod_dat, sdp_dat)
```
