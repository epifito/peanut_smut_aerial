...
### Summarise to spores/cm<sup>2</sup> per 90 minutes

Summarise the spore data into the total number of spores collected in each field at each time slice at each trap by combining the traps' samples and subsubsamples.
Then using weights, calculate the mean number of spores trapped per ninety minutes and convert this values to spores/cm<sup>2</sup>.
