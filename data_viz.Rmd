...
```{r save-spores-cardinal, eval=FALSE, echo=FALSE}
ggsave(
  last_plot(),
...
```{r save-wr, echo=FALSE, eval=FALSE}
ggsave(
  last_plot(),
...
```{r save-spore-gradient, eval=FALSE, echo=FALSE}
ggsave(
  last_plot(),
...
```{r save-spore-type-size, eval=FALSE, echo=FALSE}
ggsave(
  last_plot(),
