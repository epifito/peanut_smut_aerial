...
A script detailing the comparison of different models that were explored for the purposes of predicting the spores per cm2 is available for reference, [fit_incidence.R](fit_incidence.R "R script detailing several models that were evaluated for fitness with the data.").
