...
vis.gam(m1,
        theta = 50,
        ticktype = "detailed",
        main = "Time slice and distance from field (m)")
vis.gam(
  m1,
  theta = 50,
  view = c("wind_sin", "distance_m"),
  ticktype = "detailed",
  main = "Wind direction (sin) and distance from field (m)"
)
vis.gam(
  m1,
  theta = 45,
...
All of the predictive factors included were significant at *P* \> 0.1 and the model had an adjusted R2 value of 0.726.
...
The curvature of `distance_m` is a bit suspect, but without more data, nothing can be done, the model is appropriate for this data set but likely lacks explanatory power much beyond this set.
