...
Presumably due to the large number of outliers in the original data set, the residual plots show some patterns and the QQ-plot for the random effects indicate some issues with extreme values.
However, the `gam.check()` seems satisfactory and the adjusted R-squared value is 0.811.
