...
vis.gam(m1,
        theta = 50,
        ticktype = "detailed",
        main = "Time slice and wind speed")
vis.gam(
  m1,
  theta = 50,
  view = c("wind_speed", "distance_m"),
  ticktype = "detailed",
  main = "Wind speed and distance from field"
)
vis.gam(
  m1,
  theta = 45,
...
The model fully converged after 8 iterations.
...
newd <- expand_grid(
  ...
  wind_speed = seq(from = 0, to = 10, by = 0.5),
